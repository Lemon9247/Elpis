...
from hermes.display import DisplayConfig, DisplayManager
...
class HermesREPL:
    """
    Interactive REPL (Read-Eval-Print Loop) for Hermes.
        ...
        if server_task.done():
            try:
                ...
                self.display.print_info(
                    "Note: Hermes spawns elpis-server as a subprocess. "
